...
private:
  ...
  Tile _tiles[2][_BOARD_SIZE]; // A 2D array, each player has their own row of
                               // tiles
  ...
  void initializeTiles(
      int player_index); // Initializes individual tracks for players
...
public:
  ...
  int getPathType(int player_index); // gets the value 0 - cub taining or 1- pridelands,
   // this is helpful for tile events
  int getRoll();
